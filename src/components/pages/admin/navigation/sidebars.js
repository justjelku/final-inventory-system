	...
	return (
	  <div style={{ display: 'flex', height: '100vh', overflow: 'scroll initial' }}>
		<CDBSidebar textColor="#fff" backgroundColor="#333" className={sidebarMinimized ? 'sidebar-minimized' : ''}>
		  ...
		  <CDBSidebarContent className={`sidebar-content ${sidebarMinimized ? 'sidebar-content-minimized' : ''}`}>
			<CDBSidebarMenu>
		  ...
		  <CDBSidebarFooter>
			<div className={`container-fluid d-flex align-items-center m-3 ${sidebarMinimized ? 'container-fluid-minimized' : ''}`}>
			  {!sidebarMinimized && (
				<>
